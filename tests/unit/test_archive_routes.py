...
class TestArchiveRoutes:
    ...
    @pytest.fixture
    def test_prayer_data(self, auth_user):
    ...
    def test_download_user_archive_access_denied(self, client, temp_archive_setup, auth_user):
        ...
        with patch('app_helpers.routes.archive_routes.require_full_auth') as mock_auth:
            mock_auth.return_value = (user_mock, session_mock)
    ...
    def test_download_user_archive_admin_access(self, client, temp_archive_setup, admin_user):
        ...
        with patch('app_helpers.routes.archive_routes.require_full_auth') as mock_auth:
            mock_auth.return_value = (admin_mock, session_mock)
    ...
    def test_get_prayer_archive_file(self, client, temp_archive_setup, auth_user, test_prayer_data):
    ...
    def test_get_prayer_archive_file_not_found(self, client, temp_archive_setup, auth_user):
    ...
    def test_get_prayer_archive_file_no_archive(self, client, temp_archive_setup, auth_user):
