...
class TestArchiveWorkflow:
    ...
    def test_restore_only_removes_archive_attribute(self, test_session):
        ...
        prayer.set_attribute('answered', 'true', user.display_name, test_session)
        prayer.set_attribute('archived', 'true', user.display_name, test_session)
        prayer.set_attribute('answer_testimony', 'Blessed!', user.display_name, test_session)
        test_session.commit()
...
class TestAnsweredWorkflow:
    ...
    def test_mark_prayer_answered_basic(self, test_session):
        ...
        prayer.set_attribute('answered', 'true', user.display_name, test_session)
        prayer.set_attribute('answer_date', answer_date, user.display_name, test_session)
        test_session.commit()
    ...
    def test_testimony_can_be_updated(self, test_session):
        ...
        # Update testimony
        prayer.set_attribute('answer_testimony', 'Updated testimony with more details', user.display_name, test_session)
        test_session.commit()
...
class TestActivityLogging:
    ...
    def test_remove_attribute_creates_activity_log(self, test_session):
        ...
        assert removal_log.user_id == user.display_name
